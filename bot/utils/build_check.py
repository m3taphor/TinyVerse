        ...
        if main_js_formats:
            ...
            for js in main_js_formats:
                if last_actual_js in js:
                    ...
                    if press_key:
                        input("Bot updates detected. Contact me to check if it's safe to continue: https://t.me/UglyTalk"
            ...
            if press_key:
                input("No main js file found. Contact me to check if it's safe to continue: https://t.me/UglyTalk"
                      "\nPress 'Enter' to stop the bot...")
